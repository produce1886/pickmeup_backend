...
//    }
    ...
    @Transactional
    public Page<Project> findAll(Pageable pageable, ProjectPaginationRequestDto requestDto) {
        // 전체 조회이면
        if(requestDto.getPage() == null && requestDto.getSize() ==  null && requestDto.getSortColumn() ==  null) {
            return projectRepository.findAll(pageable);
        }

        // 전체 조회 + 페이지네이션
        else if (requestDto.getPage() != null && requestDto.getSize() !=  null && requestDto.getSortColumn() ==  null) {
        ...
        // sorting
            ...
            PageRequest pageRequest = PageRequest.of(requestDto.getPage(), requestDto.getSize(), Sort.by(requestDto.getSortColumn()).descending());
            return projectRepository.findAll(pageRequest);
        }
