...
//
//        List<Tag> hotTags = tagRepository.getTagListByScore();
//
//        List<TagScoreResponseDto> tagScoreResponseDtoList = new ArrayList<>();
//
//        if(hotTags.isEmpty()) return tagScoreResponseDtoList;
//
//        for(Tag tag : hotTags) {
//            tagScoreResponseDtoList.add(new TagScoreResponseDto(tag));
//        }
//
//        return tagScoreResponseDtoList;
//    }
