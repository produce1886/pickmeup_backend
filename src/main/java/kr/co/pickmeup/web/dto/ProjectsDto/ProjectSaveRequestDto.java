...
public class ProjectSaveRequestDto {
    ...
    @Builder
    public ProjectSaveRequestDto(String title, String content, String email, String category, String huntingField, String region, String projectCategory, String[] tags) {
        this.title = title;
