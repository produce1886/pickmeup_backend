package pickmeup.api.service.board;

import lombok.RequiredArgsConstructor;
import org.springframework.stereotype.Service;
import pickmeup.api.advice.exception.CNotOwnerException;
import pickmeup.api.advice.exception.CResourceNotExistException;
...
import pickmeup.api.model.board.ParamsPost;
import pickmeup.api.repo.board.BoardJpaRepo;
import pickmeup.api.repo.board.PostJpaRepo;
...
public class BoardService {
    ...
    public Post getPost(long postId) {
        Optional<Post> test = postJpaRepo.findById(postId);
