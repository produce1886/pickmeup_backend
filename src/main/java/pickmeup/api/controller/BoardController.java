...
import pickmeup.api.model.response.ListResult;
import pickmeup.api.model.response.SingleResult;
import pickmeup.api.service.ResponseService;
import pickmeup.api.service.board.BoardService;
...
public class BoardController {
    ...
    public SingleResult<Post> post(@PathVariable long postId) {
        Post test = boardService.getPost(postId);
    ...
    public SingleResult<Post> post(@PathVariable long postId, @Valid @ModelAttribute ParamsPost post) {
        Authentication authentication = SecurityContextHolder.getContext().getAuthentication();
        String uid = authentication.getName();
        //String test = authentication.toString();
